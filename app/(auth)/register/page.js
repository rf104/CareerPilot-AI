      ...
      <div className="glass-card p-8 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <label className="flex items-start gap-2 cursor-pointer select-none">
            <input
              type="checkbox"
              className="w-4 h-4 mt-0.5 rounded border-slate-600 bg-transparent accent-violet-500"
              checked={acceptTerms}
          ...
          <button
            ...
            disabled={loading}
            className="btn-primary w-full py-3 text-base mt-1 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="flex items-center gap-4 my-7">
          ...
          <span className="text-xs text-slate-500 uppercase tracking-wider">or sign up with</span>
          <div className="flex-1 h-px bg-slate-700/50" />
        </div>
